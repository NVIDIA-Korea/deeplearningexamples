...
import os
import my_modeling
# import optimization  # disabled for inference only
import tokenization 
import tensorflow as tf
# import horovod.tensorflow as hvd # disabled for inference only
import time
...
def get_frozen_tftrt_model(bert_config, shape, num_labels, use_one_hot_embeddings, init_checkpoint):
  ...
  with tf.Session(config=tf_config) as tf_sess:
    ...
    (assignment_map, initialized_variable_names) = my_modeling.get_assignment_map_from_checkpoint(tvars, init_checkpoint)
